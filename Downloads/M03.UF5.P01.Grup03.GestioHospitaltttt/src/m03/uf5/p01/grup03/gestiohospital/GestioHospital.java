...
public class GestioHospital {
    ...
    public static int validarCodigo(int codigo) {
        do {
            ...
            if (codigo > Historial.numHistorial) {
                System.out.println("El codigo es demasiado grande, el numero maximo es: " + Historial.numHistorial);
                codigo = in.nextInt();
            }
        } while (codigo <= Historial.numHistorial);
        return codigo;
    }
